                ...
                "properties": {
                    ...
                    "action_name": {"type": "string", "enum": [
                        ...
                        "test_skills", "audit_skills", "check_email_urgency"
                                    ...
                                    "description": "Built-in action (for task_type=action). notify_summary = push a 1-2 sentence summary of the chat's last message as a notification; pair it with trigger_type=event + trigger_event=agent_turn_end to ping the user when you finish your work."},
                    ...
                    "trigger_event": {"type": "string", "enum": ["agent_turn_end", "session_created", "message_sent", "document_created", "memory_added", "research_completed", "email_received", "skill_added"],
                                      "description": "Event name (for trigger_type=event). agent_turn_end = fires after the agent finishes a multi-step turn (>=2 rounds or used a tool) — use it with action_name=notify_summary for 'notify me when you're done'."},
