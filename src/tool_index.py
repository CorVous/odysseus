...
BUILTIN_TOOL_DESCRIPTIONS: Dict[str, str] = {
    ...
    "read_file": "Read a file from disk and return its contents. View source code, config files, logs. Returns at most ~20k chars per call — page large files with offset/limit, advancing offset until the result has no truncation notice.",
